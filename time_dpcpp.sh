...
cd dpcpp/srad/srad_v1
pwd
for (( i=0; i<$numExecutions; i++ ))
do
    ./srad 100 0.5 512 512 | grep "Total time:" >> ../../../timing/srad/srad_v1/dpcpp.txt
done
...
for (( i=0; i<$numExecutions; i++ ))
do
    ./srad 512 512 0 31 0 31 0.5 2 | grep "Total time:" >> ../../../timing/srad/srad_v2/dpcpp.txt
done
